#!/opt/mnt/miniconda3/envs/pulsar/bin/python3.10

#Borrowed and modified from BL-sigproc
...
machine_ids = {"unset": 0, "PSPM": 1, "Wapp": 2,"AOFTM": 3,
...
if __name__ == "__main__":
    ...
    print("cat %s >> %s"%(sys.argv[1], basefilenm+".tim"))
